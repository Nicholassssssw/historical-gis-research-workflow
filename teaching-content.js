...
window.TEACHING_STEPS = [
  {
    ...
    prompt: '請先判斷文本來源時期，只根據文本內容抽取具名地理實體。為每項輸出地名、日期、經過／提及狀態及證據原句；不要使用模型記憶補充文本未提供的資料。'
  },
  {
    numeral: '貳',
    stepLabel: '步驟二',
    ...
    prompt: '請為候選地名分別建立歷史行政區與現代行政區欄位。只使用原文行政界線、旅行年代相符的歷史資料及已確認路線作證據；現代同名不得單獨視為同一地點。'
  },
  {
    numeral: '叁',
    stepLabel: '步驟三',
    ...
    prompt: '請搜尋與候選地名及其歷史府縣相關的地方志記錄，提取地方志名稱、版本、卷次、原句、參照地點、方向及里程；分清原志記載、轉引與研究者推論。'
  },
  {
    numeral: '肆',
    stepLabel: '步驟四',
    ...
    prompt: '請根據歷史行政區、前後已確認站點、方向及里程，為每個候選地名設定可解釋的經緯度搜尋範圍。若只有區域級證據，保留待核，不得用縣治或中心點冒充具體地物座標。'
  },
  {
    numeral: '伍',
    stepLabel: '步驟五',
    ...
    prompt: '請在指定經緯度範圍內查詢可用地名 Database 及 API，比較地名／異名、年代、歷史與現代行政區及空間位置。保留所有候選、資料來源與判定原因，不要只採用搜尋結果第一項。'
  },
  {
    numeral: '陸',
    stepLabel: '步驟六',
